...
export const galleryCategories: GalleryCategory[] = [
  {
    ...
    images: [
      { src: '/images/gallery/placeholders/01.svg', alt: { pt: 'Mid fade em destaque', en: 'Featured mid fade', es: 'Mid fade destacado' } },
  ...
  },
  {
    ...
    images: [
      { src: '/images/gallery/placeholders/01.svg', alt: { pt: 'Low fade em destaque', en: 'Featured low fade', es: 'Low fade destacado' } },
  ...
  },
  {
    ...
    images: [
      { src: '/images/gallery/placeholders/01.svg', alt: { pt: 'Barba em destaque', en: 'Featured beard grooming', es: 'Barba destacada' } },
  ...
  },
  {
    ...
    images: [
      { src: '/images/gallery/placeholders/01.svg', alt: { pt: 'Trabalho da barbearia em destaque', en: 'Featured barbershop work', es: 'Trabajo destacado de la barbería' } },
